...
This creates a folder named Electrum-BERY.app.
...
Copy the Electrum-BERY.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrum-bery
    ./contrib/build-osx/package.sh ~/Electrum-BERY.app/
