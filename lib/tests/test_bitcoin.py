...
class Test_bitcoin(unittest.TestCase):
    ...
    def test_address_to_script(self):
        ...
        self.assertEqual(address_to_script('BERY1QW508D6QEJXTDG4Y5R3ZARVARY0C5XW7KGMN4N9'), '0014751e76e8199196d454941c45d1b3a323f1433bd6')
        self.assertEqual(address_to_script('bery1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k0tul4w'), '5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6')
        self.assertEqual(address_to_script('BERY1SW50QZGYDF5'), '6002751e')
        self.assertEqual(address_to_script('bery1zw508d6qejxtdg4y5r3zarvaryvdzur3w'), '5210751e76e8199196d454941c45d1b3a323')
...
class Test_bitcoin_testnet(TestCaseForTestnet):
    ...
    def test_address_to_script(self):
        # bech32 native segwit
        # test vectors from BIP-0173
        self.assertEqual(address_to_script('tbery1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qsnr4fp'), '00201863143c14c5166804bd19203356da136c985678cd4d27a1b8c6329604903262')
        self.assertEqual(address_to_script('tbery1qqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvsesu9tmgm'), '0020000000c4a5cad46221b2a187905e5266362b99d5e91c6ce24d165dab93e86433')
...
class Test_keyImport(unittest.TestCase):
    ...
    priv_pub_addr = (
           ...
           {'priv': 'L8g5V8kFFeg2WbecahRSdobARbHz2w2STH9S8ePHVSY4fmia7Rsj',
            ...
            'address': 'bery1qqmpt7u5e9hfznljta5gnvhyvfd2kdd0rpnd2yf',
            'minikey': False,
            'txin_type': 'p2wpkh',
            'compressed': True,
           ...
           {'priv': 'p2wpkh:T53nQpon8i8fuQHkEejzyQMYA8Gc813w2XeKcvKfkBG9jCjWvCGN',
            ...
            'address': 'bery1qpakeeg4d9ydyjxd8paqrw4xy9htsg532z7uhvl',
            'minikey': False,
            'txin_type': 'p2wpkh',
            'compressed': True,
            'addr_encoding': 'bech32',
