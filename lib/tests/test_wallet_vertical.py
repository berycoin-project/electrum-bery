...
class TestWalletKeystoreAddressIntegrityForMainnet(unittest.TestCase):
    ...
    def test_electrum_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'bery1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e')
        self.assertEqual(w.get_change_addresses()[0], 'bery1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjazfzj3')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'bery1qcr8te4kr609gcawutmrza0j4xv80jy8z4nqduv')
        self.assertEqual(w.get_change_addresses()[0], 'bery1q8c6fshw2dlwun7ekn9qwf37cu2rn755u9ym7p0')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'bery1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqa9a79a')
        self.assertEqual(w.get_change_addresses()[0], 'bery1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usxndfdg')
