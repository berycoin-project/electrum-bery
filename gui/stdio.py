...
from electrum_bery.util import format_satoshis, set_verbosity
from electrum_bery.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-bery create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Berycoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-bery setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-bery setconfig' to change your settings")
        return True
