...
from electrum_bery.util import base_units_list
...
from electrum_bery import coinchooser

from .choice_dialog import ChoiceDialog

Builder.load_string('''
#:import partial functools.partial
#:import _ electrum_bery_gui.kivy.i18n._
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Berycoin amounts.")
