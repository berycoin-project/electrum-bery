...
from electrum_bery_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_bery.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_bery"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_bery:externalType",
                '',
                data)
        return extRecord
