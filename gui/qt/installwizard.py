...
from electrum_bery import Wallet, WalletStorage
from electrum_bery.util import UserCancelled, InvalidPassword
from electrum_bery.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum-BERY  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/electrum-bery.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('Electrum-BERY wallet'))
