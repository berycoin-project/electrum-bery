...
from electrum_bery.util import PrintError, UserCancelled
from electrum_bery.keystore import bip39_normalize_passphrase
from electrum_bery.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the berycoins in the wallet.").format(self.device)
        else:
